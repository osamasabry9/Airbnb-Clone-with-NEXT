  ...
  return (
    <footer>
      <div className="mx-auto max-w-screen-xl px-4 pb-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-y-10 md:px-24 md:py-10 sm:px-8 sm:py-8 bg-gray-100 text-gray-600">
          {links.map((link) => (
          ...
          <ul className="flex justify-center gap-6 sm:justify-end">
            <li>
              <a
                ...
                rel="noreferrer"
                target="_blank"
                className="text-red-400 transition hover:text-red-400/75"
              >
